...
// Nút bật tắt giao diện
const element = document.querySelector('nav');
const elemnt_1 = document.querySelector('footer');
const element_2=document.querySelector('section');
var checkbox_toggle =document.getElementById('light-dark');
checkbox_toggle.addEventListener('change', function(){
    document.body.classList.toggle('dark');
    element.classList.toggle('blue');
    elemnt_1.classList.toggle('likebody');
    element_2.classList.toggle('likeBody');
});
// Shopping cart//
...
for (var i = 0; i < add_cart.length; i++) {
  ...
  add.addEventListener("click", function (event) {
    ...
    var img = product.getElementsByClassName("img_banchay")[0].src
    var title = product.getElementsByClassName("product-name")[0].innerText
    var price = product.getElementsByClassName("buy-now")[0].innerText
  ...
  if (user != "") {
    alert("Welcome again " + user);
     ...
     if (user != "" && user != null) {
       ...
       alert("Thank "+ user + " for this lovely gift and we wish you good luck !");
     }
  }
}